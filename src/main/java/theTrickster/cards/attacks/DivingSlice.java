...
public class DivingSlice extends AbstractDynamicCard {
    ...
    public static final String ID = DefaultMod.makeID(DivingSlice.class.getSimpleName());
    public static final String IMG = makeCardPath("Attack.png");// "public static final String IMG = makeCardPath("DivingSlice.png");
