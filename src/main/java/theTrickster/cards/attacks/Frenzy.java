...
public class Frenzy extends AbstractDynamicCard {
    ...
    public static final String ID = DefaultMod.makeID(Frenzy.class.getSimpleName());
    public static final String IMG = makeCardPath("Attack.png");// "public static final String IMG = makeCardPath("Frenzy.png");
