...
public class DebilitatingShot extends AbstractDynamicCard {
    ...
    public static final String ID = DefaultMod.makeID(DebilitatingShot.class.getSimpleName());
    public static final String IMG = makeCardPath("Attack.png");// "public static final String IMG = makeCardPath("DebilitatingShot.png");
