...
public class BattlePlan extends AbstractDynamicCard {
    ...
    public static final String ID = DefaultMod.makeID(BattlePlan.class.getSimpleName());
    public static final String IMG = makeCardPath("Attack.png");// "public static final String IMG = makeCardPath("BattlePlan.png");
